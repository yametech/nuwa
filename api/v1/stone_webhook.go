...
// +kubebuilder:webhook:path=/mutate-nuwa-nip-io-v1-stone,mutating=true,failurePolicy=fail,groups=nuwa.nip.io,resources=stones,verbs=create;update,versions=v1,name=mstone.kb.io

var _ webhook.Defaulter = &Stone{}
...
// +kubebuilder:webhook:verbs=create;update,path=/validate-nuwa-nip-io-v1-stone,mutating=false,failurePolicy=fail,groups=nuwa.nip.io,resources=stones,versions=v1,name=vstone.kb.io

var _ webhook.Validator = &Stone{}
